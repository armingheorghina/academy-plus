...
/*   Updated: 2015/12/14 18:59:02 by vdruta           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_process_o_no_lm(va_list ap, int *bytes, char *descriptor, t_arg arg)
{
	unsigned int	nbr;
	char			*str;
...
void	ft_process_o_(va_list ap, int *bytes, char *descriptor, t_arg arg)
{
	if (arg.lm_l)
		...
		ft_process_o_no_lm(ap, bytes, descriptor, arg);
}
